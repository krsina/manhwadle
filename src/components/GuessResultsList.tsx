...
// 1. Update the props interface to ACCEPT formatHeight
interface GuessResultsListProps {
  guesses: GuessResult[];
  formatHeight: (inches: number) => string;
}

// 2. DESTRUCTURE formatHeight from the component's props
const GuessResultsList: React.FC<GuessResultsListProps> = ({ guesses, formatHeight }) => {
    ...
    <div className="w-full max-w-5xl mx-auto overflow-x-auto">
      ...
      {guesses.map((guess, index) => (
        <GuessRow
            ...
            guessResult={guess}
            isNewest={index === 0}
            // 3. PASS the received function down to GuessRow
